...
PUBLIC_ERROR_MESSAGES = {
    ...
    "REVIEW_AUDIO_NOT_FOUND": "Review audio is not available for this job.",
    "REVIEW_AUDIO_GENERATION_FAILED": "The Worker could not create review audio safely.",
    "REVIEW_AUDIO_VERIFICATION_FAILED": "Review audio failed its integrity check.",
